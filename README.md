...
📜 [Paper](https://openreview.net/forum?id=LTDtjrv02Y)
...
This repo contains the code that was used for the paper ["SCOPE: A Self-supervised Framework for Improving Faithfulness in Conditional Text Generation"](https://openreview.net/forum?id=LTDtjrv02Y):
```
@inproceedings{
    duong2025scope,
